...
public interface Constants {
	...
	// 			8				9				10
			"30 y más", "Elite 19 y más", "Veteran PRO 30 y más"};

	//									  0		  1			 				2			3			4			5
	String[] cat_espanya_cruiser_masc = {"NO", "Chicos de 13 a 16 años", "17 a 29", "30 a 39", "40 y más", "PRO 17 y más años"};

	//							  0		   1		  2			 3			4
	String[] cat_espanya_fem = {"5 a 7", "8 a 10", "11 a 13", "14 a 16", "Elite 17 y más"};
